                ...
                <div class="ec-main-menu">
                    <ul>
                        ...
                        <li class="dropdown"><a href="javascript:void(0)">Компания</a>
                            <ul class="sub-menu">
                                <li><a href="about-us.html">Почему мы</a></li>
                                <li><a href="contact-us.html">Контакты</a></li>
                                <li><a href="cart.html">Пользовательское соглашение</a></li>
                                <li><a href="checkout.html">Политика конфиденциальности</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="sub-menu">
                                <li class="dropdown position-static"><a href="">Поставщикам </a></li>
                                <li class="dropdown position-static"><a href="">Партнерам</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
