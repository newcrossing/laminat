...
@section('content')
    ...
    <section class="invoice-list-wrapper">
        ...
        <div class="invoice-create-btn mb-1">
            <a href="{{route('backend.type.create')}}" class="btn btn-primary glow invoice-create" role="button"
                    ...
                    <tr>
                        ...
                        <td class="">
                            ...
                            <a class="readable-mark-icon"
                               href="{{route('backend.type.edit',$item->id)}}">{{ Str::limit($item->name, 40)  }}</a><br>
