...
@section('content')
    ...
    <section class="invoice-list-wrapper">
        ...
        <div class="invoice-create-btn mb-1">
            <a href="{{route('backend.slider.create')}}" class="btn btn-primary glow invoice-create" role="button"
                ...
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="readable-mark-icon" href="{{route('backend.slider.edit',$item->id)}}">{{ Str::limit($item->name, 40)  }}</a>
                        </td>
                        <td>
                            {{ ($item->type)  }}
                        </td>
