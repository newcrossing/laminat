...
$.extend($.easing, {
    ...
    Wolmart.$window = t(window), Wolmart.$body = t(document.body), Wolmart.status = "", Wolmart.isIE = navigator.userAgent.indexOf("Trident") >= 0, Wolmart.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Wolmart.call = function (t, e) {
        ...
        var e = window.pageXOffset, i = window.pageYOffset, a = t.getBoundingClientRect(), n = a.left + e, o = a.top + i;
    ...
    }, Wolmart.stickyDefaultOptions = {minWidth: 992, maxWidth: 2e4, top: !1, hide: !1, scrollMode: !0}, Wolmart.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0
    }, Wolmart.stickyProductOptions = {minWidth: 0, maxWidth: 2e4, scrollMode: !0, top: !1, hide: !1}, Wolmart.windowResized = function (e) {
        ...
        if ("function" == typeof imagesLoaded && t.fn.isotope) {
            ...
            Wolmart.$(e).each((function () {
                var e = t(this), n = t.extend(!0, {}, a.isotopeOptions, Wolmart.parseOptions(e.attr("data-grid-options")), i || {});
    ...
    }, Wolmart.animationOptions = {name: "fadeIn", duration: "1.2s", delay: ".2s"}, Wolmart.appearAnimate = function (e) {
        Wolmart.$(e).each((function () {
            var e = this;
        ...
        t.fn.countdown && Wolmart.$(e).each((function () {
            var e = t(this), i = e.data("until"), a = e.data("compact"), n = e.data("format") ? e.data("format") : "DHMS",
        ...
        "object" == typeof noUiSlider && Wolmart.$(e).each((function () {
            var e = this;
            noUiSlider.create(e, t.extend(!0, {start: [0, 400], connect: !0, step: 1, range: {min: 0, max: 635}}, i)), e.noUiSlider.on("update", (function (i, a) {
                i = i.map((function (t) {
                    return "$" + parseInt(t)
                }));
    ...
    }, Wolmart.zoomImageOptions = {responsive: !0, borderSize: 0, zoomType: "inner", onZoomIn: !0, magnify: 1.1}, Wolmart.zoomImageObjects = [], Wolmart.zoomImage = function (e) {
        ...
        Wolmart.$body.hasClass("home") && "true" !== Wolmart.getCookie("hideNewsletterPopup") && setTimeout((function () {
            Wolmart.popup({
                items: {src: ".newsletter-popup"}, type: "inline", tLoading: "", mainClass: "mfp-newsletter mfp-fadein-popup", callbacks: {
            ...
            e.preventDefault(), Wolmart.popup({
                items: {src: '<video src="' + t(e.currentTarget).attr("href") + '" autoplay loop controls>', type: "inline"},
            ...
            e.preventDefault(), Wolmart.popup({
                items: {src: t(e.currentTarget).attr("href")}, callbacks: {
    ...
    var i = function (t) {
        ...
        t(this.wrapperEl).find(".swiper-slide-active .slide-animate").each((function () {
            var i = t(this), a = t.extend(!0, {}, Wolmart.animationOptions, Wolmart.parseOptions(i.data("animation-options"))), n = a.duration, o = a.delay, s = a.name;
            setTimeout((function () {
        ...
        i.translateFlag = 1, i.prev = i.next, a.find(".swiper-slide .slide-animate").each((function () {
            var e = t(this), i = t.extend(!0, {}, Wolmart.animationOptions, Wolmart.parseOptions(e.data("animation-options")));
        ...
        if (1 == i.translateFlag) {
            if (i.next = this.slider.activeIndex, a.find(".show-content").removeClass("show-content"), i.prev != i.next) {
                ...
                a.find(".swiper-slide-active .slide-animate").each((function () {
                    var e = t(this), a = t.extend(!0, {}, Wolmart.animationOptions, Wolmart.parseOptions(e.data("animation-options"))), n = a.duration, o = a.delay, s = a.name;
    ...
    e.defaults = {slidesPerView: 1, speed: 300}, e.presets = {
        ...
        var p = c.children(".swiper-button-next"), u = c.children(".swiper-button-prev"), m = c.children(".swiper-pagination"), h = c.children(".custom-dots");
        if (!c.data("slider")) {
    ...
    var e = {
        init: function () {
            ...
            Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", (function (e) {
                ...
                a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="#" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'), a = t(".page-wrapper > .compare-popup")), Wolmart.$body.on("click", ".product .btn-compare", (function (o) {
                    var s = t(this);
                    s.hasClass("added") && returne(), o.preventDefault(), s.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function () {
                        s.removeClass("load-more-overlay loading"), s.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), s.attr("href", "#"), a.addClass("show")
                    }), 500);
                    var r = s.closest(".product").find("img").eq(0).attr("src");
                    i.length >= 4 && i.shift(), i.push(r), t(".compare-popup li").each((function (t) {
                        i[t] && (this.innerHTML = '<a href="#"><figure><img src="' + i[t] + '"/></figure></a>                                        <a href="#" class="btn btn-remove"><i class="w-icon-times-solid"></i></a>')
                    })), e = i.length, n()
    ...
    var i = function () {
        ...
        i.hasClass("added") || (e.preventDefault(), i.addClass("load-more-overlay loading"), setTimeout((function () {
            i.removeClass("load-more-overlay loading").toggleClass("w-icon-heart").toggleClass("w-icon-heart-full").addClass("added").attr("href", "#")
        }), 500))
    }, n = function (e) {
    ...
    e.prototype.init = function (e) {
        ...
        var t = this.$items.find(".active img").attr("src"), e = this.$wrapper.find(".swiper-slide:first-child .product-image img"),
    ...
    function e(e) {
        ...
        if ((i = n.closest(".review-image").length ? n.closest(".review-image").find("img") : o.find(".product-single-swiper").length ? o.find(".product-single-swiper .swiper-slide:not(.cloned) img:first-child") : o.find(".product-gallery-carousel").length ? o.find(".product-gallery-carousel .swiper-slide:not(.cloned) img") : o.find(".product-image img:first-child")).length) {
            ...
            var r = o.find(".product-single-swiper").data("slider"), l = r ? r.activeIndex : o.find(".product-gallery .product-gallery-btn").index(n);
    ...
    function i(t) {
        t.preventDefault(), Wolmart.popup({
            items: {src: '<video src="assets/video/memory-of-a-woman.mp4" autoplay loop controls>', type: "inline"},
            mainClass: "mfp-video-popup"
        }, "video")
    }
    ...
    function n(e) {
        ...
        if (i.hasClass("disabled")) alert("Please select some product options before adding this product to your cart."); else {
            if (a.length) a.fadeOut((function () {
                ...
                var n = '<div class="alert alert-success alert-cart-product mb-2">                            <a href="#" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' + i.closest(".product-single").find(".product-title").text() + '” has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>                            </div>';
    ...
    e.defaultOptions = {
        ...
        var n = t("<table></table>"), o = t("<thead></thead>"), s = t("<tbody></tbody"), r = e.getFullYear(), l = e.getMonth(), c = new Date(r, l, 1), d = new Date(r, l + 1, 0),
            p = c.getDay();
