...
namespace Bkwld\Croppa\Facades {
     ...
     */        class Croppa {
        ...
        {
                        /** @var \Bkwld\Croppa\Helpers $instance */
        ...
        {
                        /** @var \Bkwld\Croppa\Helpers $instance */
                        return $instance->tag($url, $width, $height, $options);
        }
                    /**
        ...
        {
                        /** @var \Bkwld\Croppa\Helpers $instance */
                        return $instance->url($url, $width, $height, $options);
        }
                    /**
         * Render image.
         *
...
namespace  {
            ...
            class Croppa extends \Bkwld\Croppa\Facades\Croppa {}
